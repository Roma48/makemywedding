...
class Application extends BaseApplication implements EventSubscriberInterface
{
    ...
    public function init()
    {
        ...
        if (!$this['debug']) {
            ...
            $this['scripts']->combine('scripts', 'widgetkit-*')->combine('uikit', 'uikit*')->combine('angular', 'angular*')->combine('application', 'application{,-templates}');
        }
    ...
    public function initAdmin()
    {
        ...
        $this['scripts']->add('widgetkit-application', 'assets/js/application.js', array('uikit', 'uikit-notify', 'uikit-nestable', 'uikit-sortable', 'application', 'angular-resource', 'widgetkit-fields'));
    ...
    public function renderWidget(array $attrs)
    {
        ...
        $app    = $this;
        $regex  = '/(?<attr>href|src|poster)=([\"\'])(?!\/|\#|(mailto|news|(ht|f)tp(s?))\:)(?<url>[^\"\'>]+)\2/xiU';
