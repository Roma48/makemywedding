...
if ($item->type('media') == 'image') {
    ...
    $attrs['class'] .= ($settings['media_border'] != 'none') ? ' uk-border-' . $settings['media_border'] : '';
...
if ($item['link']) {
    if ($settings['media_overlay'] == 'link') {
        $media = '<a class="uk-overlay" href="' . $item['link'] . '" >' . $media . '<div class="uk-overlay-area"></div></a>';
    } else {
...
if ($socials && ($settings['media_overlay'] == 'social-buttons')) {
    $media = '<div class="uk-overlay">' . $media . '<div class="uk-overlay-area"><div class="uk-overlay-area-content">' . $socials . '</div></div></div>';
}
