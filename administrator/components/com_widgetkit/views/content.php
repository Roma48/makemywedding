    ...
    <div ng-switch-when="content">
        ...
        <div class="uk-clearfix">
            ...
            <div class="js-header uk-button-dropdown" data-uk-dropdown="{ mode: 'click' }">
                <button class="uk-button uk-button-primary" type="button">New Content <i class="uk-icon-caret-down"></i></button>
            ...
            <div class="uk-float-right uk-form" ng-show="data.content | length">
                <input class="uk-form-width-small uk-margin-small-right" type="text" ng-model="search.name" placeholder="Search...">
        ...
        <ul class="uk-margin-top uk-grid uk-grid-width-small-1-2 uk-grid-width-medium-1-3 uk-grid-width-large-1-4 uk-grid-width-xlarge-1-6" data-uk-grid-margin ng-if="(vm.viewmode == 'blocks' && data.content | length)">
            <li ng-repeat="content in data.content | toArray | filter:search | orderBy:'name'">
                ...
                <a class="uk-panel uk-panel-box uk-visible-hover" ng-click="vm.editContent(content)">
        ...
        <p class="uk-text-muted uk-text-center" ng-hide="data.content | length">
            You've no content created yet.
        </p>

    </div>
    <div ng-switch-when="contentEdit">

        <h2 class="uk-margin-bottom js-header">{{ content.id ? 'Edit ' + content.name : 'Create Content' }} <span class="uk-badge">{{ content.type }}</span></h2>

        <form name="form" novalidate>

            <div class="uk-form uk-margin-bottom">
                <input type="text" ng-model="content.name" class="uk-form-large uk-width-1-1" placeholder="Name" required>
            </div>

            <div class="uk-panel uk-panel-box" ng-include="content.type + '.edit'"></div>

            <p class="js-action-buttons">
                <button class="uk-button uk-button-primary" ng-click="vm.saveContent()" ng-disabled="form.$invalid">Save</button>
                <button class="uk-button" ng-click="vm.closeContent()">Close</button>
            </p>
