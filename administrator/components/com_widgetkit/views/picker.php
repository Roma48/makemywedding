<div ng-controller="pickerCtrl as vm" ng-switch="view">
    ...
    <div ng-switch-when="content">
        ...
        <div class="uk-modal-header" ng-if="!widget">
            <div class="uk-h2 uk-text-muted">Select Widget</div>
        </div>
        ...
        <div class="uk-modal-header uk-flex uk-form" ng-show="widget">
            ...
            <button class="uk-button uk-margin-small-left" ng-show="selected" ng-click="vm.editContent()" type="button">Edit</button>

            <div class="uk-button-dropdown uk-margin-small-left" data-uk-dropdown="{ mode: 'click' }">
                <button class="uk-button" type="button">New</button>
        ...
        <div ng-hide="widget">
            <ul class="uk-grid uk-grid-width-1-2 uk-grid-width-small-1-3 uk-grid-width-medium-1-5 uk-margin-large-top uk-margin-large-bottom" data-uk-grid-margin>
                <li ng-repeat="widget in data.widgets">
        ...
        <div class="uk-modal-footer">
            <button type="button" class="uk-button" ng-click="vm.close()">Close</button>
            <button type="button" class="uk-button uk-button-primary" ng-show="selected && widget" ng-click="vm.save()">Insert</button>
        </div>
    ...
    <div ng-switch-when="contentEdit">
        ...
        <form class="uk-margin-remove" name="form" novalidate>
            ...
            <div class="uk-modal-footer">
                ...
                <button class="uk-button uk-button-primary" ng-click="vm.saveContent(content)" ng-disabled="form.$invalid">Save</button>
            </div>
